...
\begin{document}
	...
	Il diagramma dei packages del server si trova in
	\textit{/qt-clustering/doc/packages.png} mentre il diagramma delle classi
	in \textit{/qt-clustering/doc/classes.png}.

	\subsection {Importare il progetto con Eclipse}
	Si può usare \textit{Gradle} direttamente da linea di comando.
