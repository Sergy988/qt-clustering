...
\begin{document}
	...
	Le estensioni rispetto al progetto originale sono due:
	\begin{enumerate}
		\item La grafica per l'applicazione client.
		\item L'algoritmo di \textbf{Principal Component Analysis}.
	\end{enumerate}

	\subsubsection{Grafica}
	La grafica per l'applicazione client è stata scritta utilizzando le
	\textbf{JavaFX}. Essa è composta da quattro sezioni:
	\begin{enumerate}
	...
	system è stato utilizzato \textbf{gradle}. E' possibile importare sia
	il progetto relativo al client sia il progetto relativo al server
	sull'IDE \textbf{Eclipse} come progetto \textit{gradle}. Durante lo
	sviluppo sono stati utilizzati i seguenti strumenti:
	\begin{itemize}
