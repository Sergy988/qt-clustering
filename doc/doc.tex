...
\begin{document}
	...
	E' possibile importare sia il progetto relativo al client sia il
	progetto relativo al server sull'IDE \textbf{Eclipse} specificando come
	tipologia di progetto \textit{gradle}. Durante lo sviluppo sono stati
